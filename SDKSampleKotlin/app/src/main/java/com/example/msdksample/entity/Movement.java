package com.example.msdksample.entity;
...
public class Movement {
    ...
    private float altitude = -1.0F;//RTK模式下的海拔高度
    ...
    public Boolean isCameraConnection() {
    ...
    public void setKeyVideoResolutionFrameRateRange(List<VideoResolutionFrameRate>  videoResolutionFrameRate) {
        this.KeyVideoResolutionFrameRateRange = videoResolutionFrameRate;
    }
}
